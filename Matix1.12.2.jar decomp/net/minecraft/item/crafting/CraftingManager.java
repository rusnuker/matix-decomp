...
public class CraftingManager
{
    ...
    private static IRecipe parseRecipeJson(final JsonObject p_193376_0_) {
    ...
    public static ItemStack findMatchingResult(final InventoryCrafting p_82787_0_, final World craftMatrix) {
    ...
    public static NonNullList<ItemStack> getRemainingItems(final InventoryCrafting p_180303_0_, final World craftMatrix) {
        ...
        final NonNullList<ItemStack> nonnulllist = NonNullList.withSize(p_180303_0_.getSizeInventory(), ItemStack.EMPTY);
