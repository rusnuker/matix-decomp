...
public class ItemTool extends Item
{
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(final EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == EntityEquipmentSlot.MAINHAND) {
            multimap.put((Object)SharedMonsterAttributes.ATTACK_DAMAGE.getName(), (Object)new AttributeModifier(ItemTool.ATTACK_DAMAGE_MODIFIER, "Tool modifier", this.damageVsEntity, 0));
