...
public class AdvancementCommand extends CommandBase
{
    ...
    private void perform(final MinecraftServer p_193516_1_, final ICommandSender p_193516_2_, final String[] p_193516_3_, final EntityPlayerMP p_193516_4_, final ActionType p_193516_5_, final Mode p_193516_6_) throws CommandException {
        if (p_193516_6_ == Mode.EVERYTHING) {
            if (p_193516_3_.length != 3) {
                throw p_193516_6_.usage(p_193516_5_);
            }
            final int j = p_193516_5_.perform(p_193516_4_, p_193516_1_.getAdvancementManager().getAdvancements());
            if (j == 0) {
            ...
            final Advancement advancement = findAdvancement(p_193516_1_, p_193516_3_[3]);
            if (p_193516_6_ == Mode.ONLY && p_193516_3_.length == 5) {
                ...
                CommandBase.notifyCommandListener(p_193516_2_, this, p_193516_5_.baseTranslationKey + ".criterion.success", advancement.getId(), p_193516_4_.getName(), s);
            }
            else {
                if (p_193516_3_.length != 4) {
                    throw p_193516_6_.usage(p_193516_5_);
                ...
                final int i = p_193516_5_.perform(p_193516_4_, list);
                if (i == 0) {
