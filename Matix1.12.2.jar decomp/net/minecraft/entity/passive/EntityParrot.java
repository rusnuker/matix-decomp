...
public class EntityParrot extends EntityShoulderRiding implements EntityFlying
{
    ...
    @Override
    public void setPartying(final BlockPos pos, final boolean p_191987_2_) {
    ...
    private static boolean playMimicSound(final World worldIn, final Entity p_192006_1_) {
        if (!p_192006_1_.isSilent() && worldIn.rand.nextInt(50) == 0) {
            final List<EntityLiving> list = worldIn.getEntitiesWithinAABB((Class<? extends EntityLiving>)EntityLiving.class, p_192006_1_.getEntityBoundingBox().grow(20.0), (com.google.common.base.Predicate<? super EntityLiving>)EntityParrot.CAN_MIMIC);
            if (!list.isEmpty()) {
    ...
    public static void playAmbientSound(final World worldIn, final Entity p_192005_1_) {
    ...
    public void setVariant(final int p_191997_1_) {
        this.dataManager.set(EntityParrot.VARIANT, p_191997_1_);
    }
