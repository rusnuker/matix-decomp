...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void readEntityFromNBT(final NBTTagCompound compound) {
        ...
        if (compound.hasKey("Team", 8)) {
            ...
            if (!flag) {
                EntityLivingBase.LOG.warn("Unable to add mob to team \"" + s + "\" (that team probably doesn't exist)");
            }
        }
    ...
    public void travel(final float p_191986_1_, final float p_191986_2_, final float p_191986_3_) {
            ...
            if (!this.isInWater() || (this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)) {
                if (!this.isInLava() || (this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)) {
                    if (this.isElytraFlying()) {
                        ...
                        this.moveRelative(p_191986_1_, p_191986_2_, p_191986_3_, f6);
                        f4 = 0.91f;
                        if (this.onGround || ModuleStrafe.isActive()) {
