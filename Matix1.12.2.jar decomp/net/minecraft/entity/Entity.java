...
public abstract class Entity implements ICommandSender
{
    ...
    public void move(final MoverType type, double x, double y, double z) {
        final EntityMoveEvent moveEvent = new EntityMoveEvent(this, x, y, z, this.noClip);
        ...
        if (this.noClip) {
            ...
            if (this.stepHeight > 0.0f && flag && (d7 != x || d9 != z)) {
                final double oldY = this.boundingBox.minY;
                final double d11 = x;
                final double d12 = y;
                final double d13 = z;
                ...
                y = this.stepHeight;
                final List<AxisAlignedBB> list2 = this.world.getCollisionBoxes(this, this.getEntityBoundingBox().expand(d7, y, d9));
    ...
    public RayTraceResult rayTrace(final double blockReachDistance, final float partialTicks) {
        ...
        final Vec3d vec3d3 = vec3d.addVector(vec3d2.x * blockReachDistance, vec3d2.y * blockReachDistance, vec3d2.z * blockReachDistance);
