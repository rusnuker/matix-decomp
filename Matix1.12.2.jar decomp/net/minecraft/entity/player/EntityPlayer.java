...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public EnumActionResult interactOn(final Entity p_190775_1_, final EnumHand p_190775_2_) {
        if (this.isSpectator()) {
        ...
        if (p_190775_1_.processInitialInteract(this, p_190775_2_)) {
            if (this.capabilities.isCreativeMode && itemstack == this.getHeldItem(p_190775_2_) && itemstack.getCount() < itemstack2.getCount()) {
