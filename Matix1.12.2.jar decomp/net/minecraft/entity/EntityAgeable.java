...
public abstract class EntityAgeable extends EntityCreature
{
    ...
    protected boolean holdingSpawnEggOfClass(final ItemStack p_190669_1_, final Class<? extends Entity> p_190669_2_) {
        if (p_190669_1_.getItem() != Items.SPAWN_EGG) {
            return false;
        }
        final Class<? extends Entity> oclass = EntityList.REGISTRY.getObject(ItemMonsterPlacer.getNamedIdFrom(p_190669_1_));
