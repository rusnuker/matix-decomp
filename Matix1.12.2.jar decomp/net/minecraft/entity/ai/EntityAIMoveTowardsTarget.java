...
public class EntityAIMoveTowardsTarget extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        if (this.targetEntity.getDistanceSqToEntity(this.creature) > this.maxTargetDistance * this.maxTargetDistance) {
            return false;
        }
    ...
    public boolean shouldContinueExecuting() {
        return !this.creature.getNavigator().noPath() && this.targetEntity.isEntityAlive() && this.targetEntity.getDistanceSqToEntity(this.creature) < this.maxTargetDistance * this.maxTargetDistance;
    }
