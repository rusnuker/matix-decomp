...
public class EntityAIWanderAvoidWaterFlying extends EntityAIWanderAvoidWater
{
    ...
    private Vec3d getTreePos() {
        ...
        final Iterable<BlockPos.MutableBlockPos> iterable = BlockPos.mutablesBetween(MathHelper.floor(this.entity.posX - 3.0), MathHelper.floor(this.entity.posY - 6.0), MathHelper.floor(this.entity.posZ - 3.0), MathHelper.floor(this.entity.posX + 3.0), MathHelper.floor(this.entity.posY + 6.0), MathHelper.floor(this.entity.posZ + 3.0));
