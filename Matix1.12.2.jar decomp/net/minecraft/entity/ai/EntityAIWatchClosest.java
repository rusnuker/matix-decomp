...
public class EntityAIWatchClosest extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        if (this.watchedClass == EntityPlayer.class) {
            this.closestEntity = this.entity.world.getClosestPlayer(this.entity.posX, this.entity.posY, this.entity.posZ, this.maxDistanceForPlayer, (Predicate<Entity>)Predicates.and((Predicate)EntitySelectors.NOT_SPECTATING, (Predicate)EntitySelectors.notRiding(this.entity)));
        }
        else {
            this.closestEntity = this.entity.world.findNearestEntityWithinAABB((Class<? extends EntityLiving>)this.watchedClass, this.entity.getEntityBoundingBox().grow(this.maxDistanceForPlayer, 3.0, this.maxDistanceForPlayer), this.entity);
        }
    ...
    public boolean shouldContinueExecuting() {
        return this.closestEntity.isEntityAlive() && this.entity.getDistanceSqToEntity(this.closestEntity) <= this.maxDistanceForPlayer * this.maxDistanceForPlayer && this.lookTime > 0;
    }
