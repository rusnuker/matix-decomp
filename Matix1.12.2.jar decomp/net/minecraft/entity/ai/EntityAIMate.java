...
public class EntityAIMate extends EntityAIBase
{
    ...
    public void updateTask() {
        ...
        ++this.spawnBabyDelay;
        if (this.spawnBabyDelay >= 60 && this.animal.getDistanceSqToEntity(this.targetMate) < 9.0) {
            this.spawnBaby();
        }
    }
    ...
    private EntityAnimal getNearbyMate() {
        ...
        for (final EntityAnimal entityanimal2 : list) {
            if (this.animal.canMateWith(entityanimal2) && this.animal.getDistanceSqToEntity(entityanimal2) < d0) {
                entityanimal = entityanimal2;
                d0 = this.animal.getDistanceSqToEntity(entityanimal2);
            }
        }
        return entityanimal;
    }
