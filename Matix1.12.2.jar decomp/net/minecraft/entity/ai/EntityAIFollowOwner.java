...
public class EntityAIFollowOwner extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        if (this.tameable.getDistanceSqToEntity(entitylivingbase) < this.minDist * this.minDist) {
            return false;
        }
    ...
    public boolean shouldContinueExecuting() {
        return !this.petPathfinder.noPath() && this.tameable.getDistanceSqToEntity(this.owner) > this.maxDist * this.maxDist && !this.tameable.isSitting();
    }
    ...
    public void updateTask() {
        ...
        if (!this.tameable.isSitting() && --this.timeToRecalcPath <= 0) {
            ...
            if (!this.petPathfinder.tryMoveToEntityLiving(this.owner, this.followSpeed) && !this.tameable.getLeashed() && !this.tameable.isRiding() && this.tameable.getDistanceSqToEntity(this.owner) >= 144.0) {
    ...
    protected boolean isTeleportFriendlyBlock(final int x, final int p_192381_2_, final int y, final int p_192381_4_, final int p_192381_5_) {
        final BlockPos blockpos = new BlockPos(x + p_192381_4_, y - 1, p_192381_2_ + p_192381_5_);
