...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        if (this.closestLivingEntity.getDistanceSq(vec3d.x, vec3d.y, vec3d.z) < this.closestLivingEntity.getDistanceSqToEntity(this.entity)) {
            return false;
        }
    ...
    public void updateTask() {
        if (this.entity.getDistanceSqToEntity(this.closestLivingEntity) < 49.0) {
