...
public class EntityAIBeg extends EntityAIBase
{
    ...
    public boolean shouldContinueExecuting() {
        return this.player.isEntityAlive() && this.wolf.getDistanceSqToEntity(this.player) <= this.minPlayerDistance * this.minPlayerDistance && this.timeoutCounter > 0 && this.hasTemptationItemInHand(this.player);
    }
