...
public class EntityVex extends EntityMob
{
    ...
    private boolean getVexFlag(final int p_190656_1_) {
        final int i = this.dataManager.get(EntityVex.VEX_FLAGS);
        return (i & p_190656_1_) != 0x0;
    }
    
    private void setVexFlag(final int p_190660_1_, final boolean p_190660_2_) {
    ...
    public void setIsCharging(final boolean p_190648_1_) {
