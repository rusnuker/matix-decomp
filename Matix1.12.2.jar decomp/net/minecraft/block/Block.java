...
public class Block
{
    ...
    protected static boolean isExceptionBlockForAttaching(final Block p_193384_0_) {
    ...
    protected static boolean isExceptBlockForAttachWithPiston(final Block p_193382_0_) {
    ...
    public boolean shouldSideBeRendered(final IBlockState blockState, final IBlockAccess blockAccess, final BlockPos pos, final EnumFacing side) {
        if (ModuleXray.isActive() && ModuleXray.getBlockList().contains(Block.REGISTRY.getIDForObject(this))) {
            return true;
        }
    ...
    @Deprecated
    public BlockFaceShape getBlockFaceShape(final IBlockAccess p_193383_1_, final IBlockState p_193383_2_, final BlockPos p_193383_3_, final EnumFacing p_193383_4_) {
    ...
    public BlockRenderLayer getBlockLayer() {
        ...
        if (ModuleXray.getBlockList().contains(Block.REGISTRY.getIDForObject(this))) {
            return BlockRenderLayer.SOLID;
        }
