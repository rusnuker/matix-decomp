...
public class BlockStateContainer
{
    ...
    protected BlockStateContainer(final Block p_i3_1_, final IProperty<?>[] p_i3_2_, final ImmutableMap<IUnlistedProperty<?>, Optional<?>> p_i3_3_) {
        this.block = p_i3_1_;
        final Map<String, IProperty<?>> map = Maps.newHashMap();
        for (final IProperty<?> iproperty : p_i3_2_) {
            validateProperty(p_i3_1_, iproperty);
        ...
        for (final List<Comparable<?>> list2 : Cartesian.cartesianProduct((Iterable<? extends Iterable<?>>)this.getAllowedValues())) {
            ...
            final StateImplementation blockstatecontainer$stateimplementation = this.createState(p_i3_1_, (ImmutableMap<IProperty<?>, Comparable<?>>)ImmutableMap.copyOf((Map)map3), p_i3_3_);
    ...
    public static class Builder
    {
        ...
        public Builder(final Block p_i2_1_) {
    ...
    static class StateImplementation extends BlockStateBase
    {
        ...
        protected StateImplementation(final Block p_i1_1_, final ImmutableMap<IProperty<?>, Comparable<?>> p_i1_2_, final ImmutableTable<IProperty<?>, Comparable<?>, IBlockState> p_i1_3_) {
            this.block = p_i1_1_;
            this.properties = p_i1_2_;
            this.propertyValueTable = p_i1_3_;
        }
        ...
        @Override
        public BlockFaceShape getBlockFaceShape(final IBlockAccess p_193401_1_, final BlockPos p_193401_2_, final EnumFacing p_193401_3_) {
