...
public class BlockConcretePowder extends BlockFalling
{
    ...
    public void onEndFalling(final World worldIn, final BlockPos pos, final IBlockState p_176502_3_, final IBlockState p_176502_4_) {
        if (p_176502_4_.getMaterial().isLiquid()) {
            worldIn.setBlockState(pos, Blocks.CONCRETE.getDefaultState().withProperty(BlockColored.COLOR, (Comparable)p_176502_3_.getValue((IProperty<V>)BlockConcretePowder.COLOR)), 3);
        }
    }
