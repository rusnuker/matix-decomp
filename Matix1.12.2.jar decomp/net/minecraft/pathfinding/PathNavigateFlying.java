...
public class PathNavigateFlying extends PathNavigate
{
    ...
    public void setCanOpenDoors(final boolean p_192879_1_) {
        this.nodeProcessor.setCanOpenDoors(p_192879_1_);
    }
    
    public void setCanEnterDoors(final boolean p_192878_1_) {
        this.nodeProcessor.setCanEnterDoors(p_192878_1_);
    }
    
    public void setCanFloat(final boolean p_192877_1_) {
