...
public class ContainerRepair extends Container
{
    ...
    public boolean canInteractWith(final EntityPlayer playerIn) {
        return this.world.getBlockState(this.selfPosition).getBlock() == Blocks.ANVIL && playerIn.getDistanceSq(this.selfPosition.getX() + 0.5, this.selfPosition.getY() + 0.5, this.selfPosition.getZ() + 0.5) <= 64.0;
    }
