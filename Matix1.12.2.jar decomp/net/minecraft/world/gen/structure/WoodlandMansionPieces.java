    ...
    static class Grid
    {
        ...
        private void recursiveCorridor(final SimpleGrid p_191110_1_, final int p_191110_2_, final int p_191110_3_, final EnumFacing p_191110_4_, final int p_191110_5_) {
            if (p_191110_5_ > 0) {
                ...
                for (int i = 0; i < 8; ++i) {
                    final EnumFacing enumfacing = EnumFacing.getHorizontal(this.random.nextInt(4));
                ...
                p_191110_1_.setIf(p_191110_2_ + enumfacing3.getFrontOffsetX(), p_191110_3_ + enumfacing3.getFrontOffsetZ(), 0, 2);
                ...
                p_191110_1_.setIf(p_191110_2_ + p_191110_4_.getFrontOffsetX() + enumfacing3.getFrontOffsetX(), p_191110_3_ + p_191110_4_.getFrontOffsetZ() + enumfacing3.getFrontOffsetZ(), 0, 2);
                ...
                p_191110_1_.setIf(p_191110_2_ + enumfacing3.getFrontOffsetX() * 2, p_191110_3_ + enumfacing3.getFrontOffsetZ() * 2, 0, 2);
            }
        }
        ...
        private void setupThirdFloor() {
            ...
            if (list.isEmpty()) {
                ...
                for (final EnumFacing enumfacing2 : EnumFacing.Plane.HORIZONTAL.facings()) {
                    if (this.thirdFloorGrid.get(i2 + enumfacing2.getFrontOffsetX(), i3 + enumfacing2.getFrontOffsetZ()) == 0) {
                ...
                if (list2.isEmpty()) {
                    ...
                    this.recursiveCorridor(this.thirdFloorGrid, i2 + enumfacing3.getFrontOffsetX(), i3 + enumfacing3.getFrontOffsetZ(), enumfacing3, 4);
                    ...
                    for (int l3 = 0; l3 < woodlandmansionpieces$simplegrid4.width; ++l3) {
                        ...
                        if (woodlandmansionpieces$simplegrid4.get(l3, k2) == 2 || flag2) {
                            ...
                            if ((i3 & 0x200000) == 0x200000) {
                                for (final EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
                                    if (woodlandmansionpieces$simplegrid4.get(l3 + enumfacing.getFrontOffsetX(), k2 + enumfacing.getFrontOffsetZ()) == 1) {
                                        list.add(enumfacing);
                                    }
                                }
                            }
                            ...
                            if (j3 == 65536) {
                                ...
                                if (!p_191125_4_.isRoomId(woodlandmansionpieces$simplegrid4, l3 + enumfacing4.getFrontOffsetX(), k2 + enumfacing4.getFrontOffsetZ(), l2, k3)) {
