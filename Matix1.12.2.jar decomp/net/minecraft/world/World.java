...
public abstract class World implements IBlockAccess
{
    ...
    public void neighborChanged(final BlockPos pos, final Block p_190524_2_, final BlockPos p_190524_3_) {
        if (!this.isRemote) {
            final IBlockState iblockstate = this.getBlockState(pos);
            try {
    ...
    public void observedNeighborChanged(final BlockPos pos, final Block p_190529_2_, final BlockPos p_190529_3_) {
        if (!this.isRemote) {
            final IBlockState iblockstate = this.getBlockState(pos);
    ...
    public void spawnAlwaysVisibleParticle(final int p_190523_1_, final double p_190523_2_, final double p_190523_4_, final double p_190523_6_, final double p_190523_8_, final double p_190523_10_, final double p_190523_12_, final int... p_190523_14_) {
        for (int i = 0; i < this.eventListeners.size(); ++i) {
            this.eventListeners.get(i).spawnParticle(p_190523_1_, false, true, p_190523_2_, p_190523_4_, p_190523_6_, p_190523_8_, p_190523_10_, p_190523_12_, p_190523_14_);
        }
    }
    ...
    private boolean getCollisionBoxes_(@Nullable final Entity p_191504_1_, final AxisAlignedBB p_191504_2_, final boolean p_191504_3_, @Nullable final List<AxisAlignedBB> p_191504_4_) {
        ...
        final boolean flag2 = p_191504_1_ != null && this.isInsideWorldBorder(p_191504_1_);
    ...
    public boolean isInsideWorldBorder(final Entity p_191503_1_) {
    ...
    public boolean collidesWithAnyBlock(final AxisAlignedBB bbox) {
        return this.getCollisionBoxes_(null, bbox, true, Lists.newArrayList());
    }
    ...
    public boolean mayPlace(final Block blockIn, final BlockPos pos, final boolean p_190527_3_, final EnumFacing sidePlacedOn, @Nullable final Entity placer) {
        final IBlockState iblockstate1 = this.getBlockState(pos);
        final AxisAlignedBB axisalignedbb = p_190527_3_ ? null : blockIn.getDefaultState().getCollisionBoundingBox(this, pos);
    ...
    @Nullable
    public EntityPlayer getClosestPlayer(final double x, final double y, final double z, final double p_190525_7_, final Predicate<Entity> p_190525_9_) {
        double d0 = -1.0;
    ...
    @Nullable
    public BlockPos findNearestStructure(final String p_190528_1_, final BlockPos p_190528_2_, final boolean p_190528_3_) {
        return null;
    }
    ...
    public List<AxisAlignedBB> isAABBInMaterial(@Nullable final Entity entityIn, final AxisAlignedBB aabb) {
