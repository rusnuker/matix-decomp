...
public class RandomMobsProperties
{
    ...
    public RandomMobsProperties(final String p_i74_1_, final ResourceLocation[] p_i74_2_) {
        this.name = null;
        this.basePath = null;
    ...
    public RandomMobsProperties(final Properties p_i75_1_, final String p_i75_2_, final ResourceLocation p_i75_3_) {
        this.name = null;
        this.basePath = null;
        this.resourceLocations = null;
        this.rules = null;
    ...
    private RandomMobsRule[] parseRules(final Properties p_parseRules_1_, final ResourceLocation p_parseRules_2_, final ConnectedParser p_parseRules_3_) {
        ...
        for (int i = p_parseRules_1_.size(), j = 0; j < i; ++j) {
            ...
            if (s != null) {
                ...
                final Biome[] abiome = p_parseRules_3_.parseBiomes(p_parseRules_1_.getProperty("biomes." + k));
                ...
                final RandomMobsRule randommobsrule = new RandomMobsRule(p_parseRules_2_, aint, aint2, abiome, rangelistint);
