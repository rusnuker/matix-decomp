...
public class TextureAnimation
{
    ...
    public TextureAnimation(final String p_i94_1_, final byte[] p_i94_2_, final String p_i94_3_, final ResourceLocation p_i94_4_, final int p_i94_5_, final int p_i94_6_, final int p_i94_7_, final int p_i94_8_, final Properties p_i94_9_, final int p_i94_10_) {
        this.srcTex = null;
        this.dstTex = null;
        this.dstTexLoc = null;
        this.dstTextId = -1;
        ...
        final int i = p_i94_7_ * p_i94_8_ * 4;
        ...
        final String s2 = (String)p_i94_9_.get("duration");
        final int l = Config.parseInt(s2, p_i94_10_);
        this.frames = new TextureAnimationFrame[j];
        for (int i2 = 0; i2 < this.frames.length; ++i2) {
            final String s3 = (String)p_i94_9_.get("tile." + i2);
            final int j2 = Config.parseInt(s3, i2);
            final String s4 = (String)p_i94_9_.get("duration." + i2);
