...
public class ReflectorMethod
{
    ...
    public ReflectorMethod(final ReflectorClass p_i90_1_, final String p_i90_2_) {
        this(p_i90_1_, p_i90_2_, null, false);
    }
    
    public ReflectorMethod(final ReflectorClass p_i91_1_, final String p_i91_2_, final Class[] p_i91_3_) {
        this(p_i91_1_, p_i91_2_, p_i91_3_, false);
    }
    
    public ReflectorMethod(final ReflectorClass p_i92_1_, final String p_i92_2_, final Class[] p_i92_3_, final boolean p_i92_4_) {
