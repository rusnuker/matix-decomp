...
public class CustomColors
{
    ...
    private static CustomColormap[] readCustomColormaps(final Properties p_readCustomColormaps_0_, final String p_readCustomColormaps_1_) {
        ...
        for (final Object o : p_readCustomColormaps_0_.keySet()) {
            final String s2 = (String)o;
            final String s3 = p_readCustomColormaps_0_.getProperty(s2);
            if (s2.startsWith(s)) {
                map.put(s2, s3);
            }
        }
    ...
    public static Vec3d getSkyColor(final Vec3d p_getSkyColor_0_, final IBlockAccess p_getSkyColor_1_, final double p_getSkyColor_2_, final double p_getSkyColor_4_, final double p_getSkyColor_6_) {
        ...
        float f2 = k / 255.0f;
        float f3 = l / 255.0f;
        final float f4 = (float)p_getSkyColor_0_.x / 0.5f;
        final float f5 = (float)p_getSkyColor_0_.y / 0.66275f;
        final float f6 = (float)p_getSkyColor_0_.z;
        f *= f4;
        f2 *= f5;
        f3 *= f6;
    ...
    private static Vec3d getFogColor(final Vec3d p_getFogColor_0_, final IBlockAccess p_getFogColor_1_, final double p_getFogColor_2_, final double p_getFogColor_4_, final double p_getFogColor_6_) {
        ...
        float f2 = k / 255.0f;
        float f3 = l / 255.0f;
        final float f4 = (float)p_getFogColor_0_.x / 0.753f;
        final float f5 = (float)p_getFogColor_0_.y / 0.8471f;
        final float f6 = (float)p_getFogColor_0_.z;
        f *= f4;
        f2 *= f5;
        f3 *= f6;
    ...
    private static int[] readSpawnEggColors(final Properties p_readSpawnEggColors_0_, final String p_readSpawnEggColors_1_, final String p_readSpawnEggColors_2_, final String p_readSpawnEggColors_3_) {
        ...
        for (final Object o : set) {
            ...
            final String s2 = p_readSpawnEggColors_0_.getProperty(s);
            if (s.startsWith(p_readSpawnEggColors_2_)) {
                final String s3 = StrUtils.removePrefix(s, p_readSpawnEggColors_2_);
    ...
    private static float[][] readDyeColors(final Properties p_readDyeColors_0_, final String p_readDyeColors_1_, final String p_readDyeColors_2_, final String p_readDyeColors_3_) {
        ...
        int k = 0;
        for (final Object o : p_readDyeColors_0_.keySet()) {
            final String s = (String)o;
            final String s2 = p_readDyeColors_0_.getProperty(s);
            if (s.startsWith(p_readDyeColors_2_)) {
                String s3 = StrUtils.removePrefix(s, p_readDyeColors_2_);
    ...
    private static int[] readTextColors(final Properties p_readTextColors_0_, final String p_readTextColors_1_, final String p_readTextColors_2_, final String p_readTextColors_3_) {
        ...
        Arrays.fill(aint, -1);
        int i = 0;
        for (final Object o : p_readTextColors_0_.keySet()) {
            final String s = (String)o;
            final String s2 = p_readTextColors_0_.getProperty(s);
            if (s.startsWith(p_readTextColors_2_)) {
                final String s3 = StrUtils.removePrefix(s, p_readTextColors_2_);
    ...
    private static int[] readMapColors(final Properties p_readMapColors_0_, final String p_readMapColors_1_, final String p_readMapColors_2_, final String p_readMapColors_3_) {
        ...
        Arrays.fill(aint, -1);
        int i = 0;
        for (final Object o : p_readMapColors_0_.keySet()) {
            final String s = (String)o;
            final String s2 = p_readMapColors_0_.getProperty(s);
            if (s.startsWith(p_readMapColors_2_)) {
                final String s3 = StrUtils.removePrefix(s, p_readMapColors_2_);
    ...
    private static int[] readPotionColors(final Properties p_readPotionColors_0_, final String p_readPotionColors_1_, final String p_readPotionColors_2_, final String p_readPotionColors_3_) {
        ...
        Arrays.fill(aint, -1);
        int i = 0;
        for (final Object o : p_readPotionColors_0_.keySet()) {
            final String s = (String)o;
            final String s2 = p_readPotionColors_0_.getProperty(s);
