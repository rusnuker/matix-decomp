...
public class TooltipManager
{
    ...
    private GuiButton getSelectedButton(final int p_getSelectedButton_1_, final int p_getSelectedButton_2_, final List p_getSelectedButton_3_) {
        for (int i = 0; i < p_getSelectedButton_3_.size(); ++i) {
            ...
            final boolean flag = p_getSelectedButton_1_ >= guibutton.x && p_getSelectedButton_2_ >= guibutton.y && p_getSelectedButton_1_ < guibutton.x + j && p_getSelectedButton_2_ < guibutton.y + k;
            if (flag) {
                return guibutton;
            }
        }
