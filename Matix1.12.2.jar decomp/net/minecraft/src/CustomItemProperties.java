...
public class CustomItemProperties
{
    ...
    private NbtTagValue[] parseNbtTagValues(final Properties p_parseNbtTagValues_1_) {
        final String s = "nbt.";
        final Map<String, String> map = getMatchingProperties(p_parseNbtTagValues_1_, s);
        if (map.size() <= 0) {
            return null;
        }
    ...
    private static Map<String, String> getMatchingProperties(final Properties p_getMatchingProperties_0_, final String p_getMatchingProperties_1_) {
        final Map map = new LinkedHashMap();
        for (final Object o : p_getMatchingProperties_0_.keySet()) {
            final String s = (String)o;
            final String s2 = p_getMatchingProperties_0_.getProperty(s);
