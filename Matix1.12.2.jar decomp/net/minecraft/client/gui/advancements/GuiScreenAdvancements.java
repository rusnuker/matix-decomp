...
public class GuiScreenAdvancements extends GuiScreen implements ClientAdvancementManager.IListener
{
    ...
    public void renderWindow(final int p_191934_1_, final int p_191934_2_) {
        ...
        this.mc.getTextureManager().bindTexture(GuiScreenAdvancements.WINDOW);
        this.drawTexturedModalRect(p_191934_1_, p_191934_2_, 0, 0, 252, 140);
        if (this.tabs.size() > 1) {
            this.mc.getTextureManager().bindTexture(GuiScreenAdvancements.TABS);
            for (final GuiAdvancementTab guiadvancementtab : this.tabs.values()) {
    ...
    public void rootAdvancementAdded(final Advancement advancementIn) {
        final GuiAdvancementTab guiadvancementtab = GuiAdvancementTab.create(this.mc, this, this.tabs.size(), advancementIn);
        if (guiadvancementtab != null) {
    ...
    @Override
    public void onUpdateAdvancementProgress(final Advancement p_191933_1_, final AdvancementProgress p_191933_2_) {
        final GuiAdvancement guiadvancement = this.getAdvancementGui(p_191933_1_);
    ...
    @Override
    public void setSelectedTab(@Nullable final Advancement p_193982_1_) {
