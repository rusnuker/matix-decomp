...
public class GuiAdvancement extends Gui
{
    ...
    public void drawConnectivity(final int p_191819_1_, final int p_191819_2_, final boolean p_191819_3_) {
        if (this.parent != null) {
            ...
            if (p_191819_3_) {
                Gui.drawHorizontalLine(j, i, k - 1, j2);
                Gui.drawHorizontalLine(j + 1, i, k, j2);
                Gui.drawHorizontalLine(j, i, k + 1, j2);
                Gui.drawHorizontalLine(l, j - 1, i2 - 1, j2);
                Gui.drawHorizontalLine(l, j - 1, i2, j2);
                Gui.drawHorizontalLine(l, j - 1, i2 + 1, j2);
                Gui.drawVerticalLine(j - 1, i2, k, j2);
                Gui.drawVerticalLine(j + 1, i2, k, j2);
            }
            else {
                Gui.drawHorizontalLine(j, i, k, j2);
                Gui.drawHorizontalLine(l, j, i2, j2);
                Gui.drawVerticalLine(j, i2, k, j2);
            }
        }
    ...
    public void getAdvancementProgress(final AdvancementProgress advancementProgressIn) {
