...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(final int width, final Scoreboard scoreboardIn, @Nullable final ScoreObjective scoreObjectiveIn) {
        ...
        if (list2 != null) {
            Gui.drawRect(width / 2 - l4 / 2 - 1, k2 - 1, width / 2 + l4 / 2 + 1, k2 + list2.size() * this.mc.fontRenderer.FONT_HEIGHT, Integer.MIN_VALUE);
        ...
        for (int k3 = 0; k3 < l3; ++k3) {
            ...
            if (k3 < list.size()) {
                ...
                if (networkplayerinfo2.getGameType() == GameType.SPECTATOR) {
                    ...
                    this.mc.fontRenderer.drawStringWithShadow(s4, (float)j4, (float)k4, -1);
                }
        ...
        if (list3 != null) {
            k2 = k2 + i2 * 9 + 1;
            Gui.drawRect(width / 2 - l4 / 2 - 1, k2 - 1, width / 2 + l4 / 2 + 1, k2 + list3.size() * this.mc.fontRenderer.FONT_HEIGHT, Integer.MIN_VALUE);
