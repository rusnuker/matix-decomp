...
public class GuiLabel extends Gui
{
    ...
    protected void drawLabelBackground(final Minecraft mcIn, final int p_146160_2_, final int p_146160_3_) {
        if (this.labelBgEnabled) {
            ...
            Gui.drawHorizontalLine(k, k + i, l, this.ulColor);
            Gui.drawHorizontalLine(k, k + i, l + j, this.brColor);
            Gui.drawVerticalLine(k, l, l + j, this.ulColor);
            Gui.drawVerticalLine(k + i, l, l + j, this.brColor);
        }
    }
}
