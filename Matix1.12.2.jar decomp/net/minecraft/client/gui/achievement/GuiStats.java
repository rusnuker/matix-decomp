...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        protected void drawSlot(final int p_192637_1_, final int p_192637_2_, final int p_192637_3_, final int p_192637_4_, final int p_192637_5_, final int p_192637_6_, final float p_192637_7_) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRenderer, s2, p_192637_2_ + 2, p_192637_3_ + 1 + GuiStats.this.fontRenderer.FONT_HEIGHT, (i == 0) ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.fontRenderer, s3, p_192637_2_ + 2, p_192637_3_ + 1 + GuiStats.this.fontRenderer.FONT_HEIGHT * 2, (j == 0) ? 6316128 : 9474192);
        }
    }
}
