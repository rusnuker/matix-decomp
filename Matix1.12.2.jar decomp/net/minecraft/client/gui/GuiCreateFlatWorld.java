...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    class Details extends GuiSlot
    {
        ...
        protected void drawSlot(final int p_192637_1_, final int p_192637_2_, final int p_192637_3_, final int p_192637_4_, final int p_192637_5_, final int p_192637_6_, final float p_192637_7_) {
            final FlatLayerInfo flatlayerinfo = GuiCreateFlatWorld.this.generatorInfo.getFlatLayers().get(GuiCreateFlatWorld.this.generatorInfo.getFlatLayers().size() - p_192637_1_ - 1);
            ...
            GuiCreateFlatWorld.this.fontRenderer.drawString(s2, p_192637_2_ + 2 + 213 - GuiCreateFlatWorld.this.fontRenderer.getStringWidth(s2), p_192637_3_ + 3, 16777215);
        }
