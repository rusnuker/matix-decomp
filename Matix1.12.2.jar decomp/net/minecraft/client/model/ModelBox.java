...
public class ModelBox
{
    ...
    public ModelBox(final ModelRenderer p_i11_1_, final int[][] p_i11_2_, float p_i11_3_, float p_i11_4_, float p_i11_5_, final float p_i11_6_, final float p_i11_7_, final float p_i11_8_, final float p_i11_9_, final boolean p_i11_10_) {
        this.posX1 = p_i11_3_;
        this.posY1 = p_i11_4_;
        this.posZ1 = p_i11_5_;
        this.posX2 = p_i11_3_ + p_i11_6_;
        this.posY2 = p_i11_4_ + p_i11_7_;
        this.posZ2 = p_i11_5_ + p_i11_8_;
        this.vertexPositions = new PositionTextureVertex[8];
        this.quadList = new TexturedQuad[6];
        float f = p_i11_3_ + p_i11_6_;
        float f2 = p_i11_4_ + p_i11_7_;
        float f3 = p_i11_5_ + p_i11_8_;
        p_i11_3_ -= p_i11_9_;
        p_i11_4_ -= p_i11_9_;
        p_i11_5_ -= p_i11_9_;
        f += p_i11_9_;
        ...
        final PositionTextureVertex positiontexturevertex7 = new PositionTextureVertex(p_i11_3_, p_i11_4_, p_i11_5_, 0.0f, 0.0f);
        final PositionTextureVertex positiontexturevertex8 = new PositionTextureVertex(f, p_i11_4_, p_i11_5_, 0.0f, 8.0f);
        final PositionTextureVertex positiontexturevertex9 = new PositionTextureVertex(f, f2, p_i11_5_, 8.0f, 8.0f);
        final PositionTextureVertex positiontexturevertex10 = new PositionTextureVertex(p_i11_3_, f2, p_i11_5_, 8.0f, 0.0f);
        final PositionTextureVertex positiontexturevertex11 = new PositionTextureVertex(p_i11_3_, p_i11_4_, f3, 0.0f, 0.0f);
        final PositionTextureVertex positiontexturevertex12 = new PositionTextureVertex(f, p_i11_4_, f3, 0.0f, 8.0f);
        final PositionTextureVertex positiontexturevertex13 = new PositionTextureVertex(f, f2, f3, 8.0f, 8.0f);
        final PositionTextureVertex positiontexturevertex14 = new PositionTextureVertex(p_i11_3_, f2, f3, 8.0f, 0.0f);
        ...
        this.quadList[0] = this.makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex12, positiontexturevertex8, positiontexturevertex9, positiontexturevertex13 }, p_i11_2_[4], false, p_i11_1_.textureWidth, p_i11_1_.textureHeight);
        this.quadList[1] = this.makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex7, positiontexturevertex11, positiontexturevertex14, positiontexturevertex10 }, p_i11_2_[5], false, p_i11_1_.textureWidth, p_i11_1_.textureHeight);
        this.quadList[2] = this.makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex12, positiontexturevertex11, positiontexturevertex7, positiontexturevertex8 }, p_i11_2_[1], true, p_i11_1_.textureWidth, p_i11_1_.textureHeight);
        this.quadList[3] = this.makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex9, positiontexturevertex10, positiontexturevertex14, positiontexturevertex13 }, p_i11_2_[0], true, p_i11_1_.textureWidth, p_i11_1_.textureHeight);
        this.quadList[4] = this.makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex8, positiontexturevertex7, positiontexturevertex10, positiontexturevertex9 }, p_i11_2_[2], false, p_i11_1_.textureWidth, p_i11_1_.textureHeight);
        this.quadList[5] = this.makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex11, positiontexturevertex12, positiontexturevertex13, positiontexturevertex14 }, p_i11_2_[3], false, p_i11_1_.textureWidth, p_i11_1_.textureHeight);
        if (p_i11_10_) {
