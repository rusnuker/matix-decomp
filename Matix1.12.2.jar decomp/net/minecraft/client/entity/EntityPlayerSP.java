...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate() {
        if (this.motionX != 0.0 || this.motionY != -0.0784000015258789 || this.motionZ != 0.0) {
            final PlayerMoveEvent moveEvent = new PlayerMoveEvent(this);
        ...
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0, this.posZ))) {
            super.onUpdate();
            final PreMotionUpdateEvent preMotionEvent = new PreMotionUpdateEvent(this);
            ...
            final PostMotionUpdateEvent postMotion = new PostMotionUpdateEvent(this);
    ...
    private void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            final PlayerUpdateWalkingEvent updateWalkingEvent = EventManager.call(new PlayerUpdateWalkingEvent());
    ...
    public void onLivingUpdate() {
        ...
        if (this.isHandActive() && !this.isRiding() && !Wrapper.getModuleManager().isModuleActive("NoItemSlowdown")) {
                ...
                if (f8 >= -0.15f) {
                    ...
                    if (iblockstate.getCollisionBoundingBox(this.world, blockpos) == null) {
                        ...
                        if (iblockstate2.getCollisionBoundingBox(this.world, blockpos) == null) {
                            ...
                            final AxisAlignedBB axisalignedbb = new AxisAlignedBB(vec3d, vec3d6.addVector(0.0, f13, 0.0)).grow(f12, 0.0, f12);
