...
public class GameSettings
{
    ...
    public static final String[] NARRATOR_MODES;
    ...
    public void setOptionValue(final Options settingsOption, final int value) {
        ...
        if (settingsOption == Options.NARRATOR) {
            if (NarratorChatListener.INSTANCE.isActive()) {
                this.narrator = (this.narrator + value) % GameSettings.NARRATOR_MODES.length;
            }
            else {
                this.narrator = 0;
            }
        ...
        if (settingOption.getEnumFloat()) {
            ...
            if (settingOption == Options.GRAPHICS) {
                ...
                if (settingOption == Options.NARRATOR) {
                    return NarratorChatListener.INSTANCE.isActive() ? (s2 + getTranslation(GameSettings.NARRATOR_MODES, this.narrator)) : (s2 + I18n.format("options.narrator.notavailable", new Object[0]));
                }
                return s2;
            }
        }
            ...
            for (final String s2 : nbttagcompound.getKeySet()) {
                ...
                try {
                    ...
                    if ("narrator".equals(s2)) {
                        this.narrator = Integer.parseInt(s3);
                    }
    ...
    static {
        ...
        NARRATOR_MODES = new String[] { "options.narrator.off", "options.narrator.all", "options.narrator.chat", "options.narrator.system" };
