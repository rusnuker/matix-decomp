...
public class RecipeItemHelper
{
    ...
    public int tryTake(final int p_194122_1_, final int maximum) {
        final int i = this.itemToCount.get(p_194122_1_);
        if (i >= maximum) {
    ...
    public boolean canCraft(final IRecipe recipe, @Nullable final IntList p_194116_2_) {
        return this.canCraft(recipe, p_194116_2_, 1);
    }
    
    public boolean canCraft(final IRecipe recipe, @Nullable final IntList p_194118_2_, final int p_194118_3_) {
        return new RecipePicker(recipe).tryPick(p_194118_3_, p_194118_2_);
    }
    
    public int getBiggestCraftableStack(final IRecipe recipe, @Nullable final IntList p_194114_2_) {
        return this.getBiggestCraftableStack(recipe, Integer.MAX_VALUE, p_194114_2_);
    }
    
    public int getBiggestCraftableStack(final IRecipe recipe, final int p_194121_2_, @Nullable final IntList p_194121_3_) {
                ...
                if (flag2 && list.get(k2) == Ingredient.EMPTY) {
                    ...
                    for (int l2 = 0; l2 < this.possessedIngredientStackCount; ++l2) {
                        if (this.hasResidual(false, j1, l2)) {
                            ...
                            RecipeItemHelper.this.increment(this.possessedIngredientStacks[l2], p_194092_1_);
                            if (flag2) {
