...
public class RecipeBookClient extends RecipeBook
{
    ...
    private static RecipeList newRecipeList(final CreativeTabs p_194082_0_) {
        final RecipeList recipelist = new RecipeList();
        RecipeBookClient.ALL_RECIPES.add(recipelist);
        RecipeBookClient.RECIPES_BY_TAB.computeIfAbsent(p_194082_0_, p_194085_0_ -> new ArrayList()).add(recipelist);
        RecipeBookClient.RECIPES_BY_TAB.computeIfAbsent(CreativeTabs.SEARCH, p_194083_0_ -> new ArrayList()).add(recipelist);
        return recipelist;
    }
    
    private static CreativeTabs getItemStackTab(final ItemStack p_194084_0_) {
