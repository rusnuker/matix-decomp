...
{
    private final Map<Class<? extends Entity>, Render<? extends Entity>> entityRenderMap;
    ...
    public void doRenderEntity(final Entity entityIn, final double x, final double y, final double z, final float yaw, final float partialTicks, final boolean p_188391_10_) {
        final PreRenderEntityEvent preRenderEvent = new PreRenderEntityEvent(entityIn, x, y, z, partialTicks);
        ...
        try {
            ...
            final PostRenderEntityEvent postRenderEvent = new PostRenderEntityEvent(entityIn, x, y, z, partialTicks);
