...
public class ChunkRenderDispatcher
{
    ...
    public ChunkRenderDispatcher(final int p_i15_1_) {
        ...
        if (p_i15_1_ < 0) {
            ...
            this.countRenderBuilders = p_i15_1_;
        }
        if (j > 1) {
            for (int k = 0; k < j; ++k) {
    ...
    private void uploadDisplayList(final BufferBuilder vertexBufferIn, final int list, final RenderChunk chunkRenderer) {
