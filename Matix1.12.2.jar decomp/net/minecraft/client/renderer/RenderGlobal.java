...
public class RenderGlobal implements IWorldEventListener, IResourceManagerReloadListener
{
    ...
    public void renderEntities(final Entity renderViewEntity, final ICamera camera, final float partialTicks) {
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            for (final ContainerLocalRenderInformation renderglobal$containerlocalrenderinformation : this.renderInfosEntities) {
                final Chunk chunk = renderglobal$containerlocalrenderinformation.renderChunk.getChunk(this.world);
                ...
                if (!classinheritancemultimap.isEmpty()) {
                    for (final Entity entity3 : classinheritancemultimap) {
                        if (!flag || Reflector.callBoolean(entity3, Reflector.ForgeEntity_shouldRenderInPass, i)) {
                            ...
                            if ((entity3 == this.mc.getRenderViewEntity() && this.mc.gameSettings.thirdPersonView == 0 && !flag6) || (entity3.posY >= 0.0 && entity3.posY < 256.0 && !this.world.isBlockLoaded(blockpos$pooledmutableblockpos.setPos(entity3)))) {
                                continue;
                            }
                            ++this.countEntitiesRendered;
    ...
    private boolean isOutlineActive(final Entity entityIn, final Entity viewer, final ICamera camera) {
        ...
        return (entityIn != viewer || this.mc.gameSettings.thirdPersonView != 0 || flag) && (entityIn.isGlowing() || (this.mc.player.isSpectator() && this.mc.gameSettings.keyBindSpectatorOutlines.isKeyDown() && entityIn instanceof EntityPlayer && (entityIn.ignoreFrustumCheck || camera.isBoundingBoxInFrustum(entityIn.getEntityBoundingBox()) || entityIn.isRidingOrBeingRiddenBy(this.mc.player))));
    }
    ...
    public void setupTerrain(final Entity viewEntity, final double partialTicks, ICamera camera, final int frameCount, final boolean playerSpectator) {
            ...
            if (!flag && this.displayListEntitiesDirty) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (renderchunk2 != null) {
                        ...
                        if (!renderchunk2.compiledChunk.isEmpty() || renderchunk2.needsUpdate()) {
                            this.renderInfos.add(renderinfolazy.getRenderInfo());
                        }
                        final BlockPos blockpos2 = renderchunk2.getPosition();
                        if (ChunkUtils.hasEntities(this.world.getChunkFromBlockCoords(blockpos2))) {
        ...
        if (!flag && this.displayListEntitiesDirty && !Shaders.isShadowPass) {
            ...
            while (!deque.isEmpty()) {
                ...
                if (!compiledchunk.isEmpty() || renderchunk4.needsUpdate()) {
                    this.renderInfos.add(renderglobal$containerlocalrenderinformation3);
                    flag4 = true;
                }
                if (ChunkUtils.hasEntities(renderchunk4.getChunk(this.world))) {
        ...
        if (Shaders.isShadowPass) {
            ...
            for (final ContainerLocalRenderInformation renderglobal$containerlocalrenderinformation5 : this.renderInfos) {
                ...
                if (renderchunk6.needsUpdate() || set2.contains(renderchunk6)) {
                    this.displayListEntitiesDirty = true;
    ...
    public int renderBlockLayer(final BlockRenderLayer blockLayerIn, final double partialTicks, final int pass, final Entity entityIn) {
        ...
        this.mc.mcProfiler.func_194339_b(() -> "render_" + blockLayerIn);
    ...
    public void renderSky(final float partialTicks, final int pass) {
        ...
        if (this.mc.world.provider.getDimensionType() == DimensionType.THE_END) {
            ...
            final double d3 = this.mc.player.getPositionEyes(partialTicks).y - this.world.getHorizon();
            if (d3 < 0.0) {
                GlStateManager.pushMatrix();
            ...
            if (this.mc.world.provider.isSurfaceWorld()) {
                ...
                if (Config.isCloudsFancy()) {
                    ...
                    if (this.cloudRenderer.shouldUpdateGlList()) {
                        ...
                        float f17 = this.world.provider.getCloudHeight() - (float)p_180447_5_ + 0.33f;
    ...
    public void updateChunks(long finishTimeNano) {
        ...
        if (!this.chunksToUpdate.isEmpty()) {
            ...
            while (iterator3.hasNext()) {
                ...
                boolean flag1;
                if (renderchunk3.needsImmediateUpdate()) {
    ...
    public static void addChainedFilledBoxVertices(final BufferBuilder builder, final double p_189693_1_, final double p_189693_3_, final double p_189693_5_, final double p_189693_7_, final double p_189693_9_, final double p_189693_11_, final float red, final float green, final float blue, final float alpha) {
    ...
    private void setPartying(final World p_193054_1_, final BlockPos pos, final boolean p_193054_3_) {
        for (final EntityLivingBase entitylivingbase : p_193054_1_.getEntitiesWithinAABB((Class<? extends EntityLivingBase>)EntityLivingBase.class, new AxisAlignedBB(pos).grow(3.0))) {
    ...
    private Particle spawnParticle0(final int particleID, final boolean ignoreRange, final boolean minParticles, final double xCoord, final double yCoord, final double zCoord, final double xSpeed, final double ySpeed, final double zSpeed, final int... parameters) {
        ...
        if (particleID == EnumParticleTypes.PORTAL.getParticleID() && !Config.isAnimatedPortal()) {
            return null;
        }
    ...
    private int calculateParticleLevel(final boolean p_190572_1_) {
    ...
    public static void drawOutlinedBoundingBox(final AxisAlignedBB axisAlignedBB, final int color) {
        final Color decode = new Color(color);
        drawOutlinedBoundingBox(axisAlignedBB, decode.getRed(), decode.getGreen(), decode.getBlue(), decode.getAlpha());
    }
    ...
    public static class ContainerLocalRenderInformation
    {
        ...
        public ContainerLocalRenderInformation(final RenderChunk p_i13_1_, final EnumFacing p_i13_2_, final int p_i13_3_) {
            this.cacheable = false;
            this.renderChunk = p_i13_1_;
            this.facing = p_i13_2_;
            this.setFacing = p_i13_3_;
        }
