...
public class TextureMap extends AbstractTexture implements ITickableTextureObject
{
    ...
    public TextureMap(final String p_i19_1_, final boolean p_i19_2_) {
        this(p_i19_1_, null, p_i19_2_);
    }
    ...
    public TextureMap(final String p_i20_1_, final ITextureMapPopulator p_i20_2_, final boolean p_i20_3_) {
        this.iconGrid = null;
        this.iconGridSize = -1;
        ...
        this.basePath = p_i20_1_;
        this.iconCreator = p_i20_2_;
    }
    ...
    private int detectMinimumSpriteSize(final Map<String, TextureAtlasSprite> p_detectMinimumSpriteSize_1_, final IResourceManager p_detectMinimumSpriteSize_2_, final int p_detectMinimumSpriteSize_3_) {
