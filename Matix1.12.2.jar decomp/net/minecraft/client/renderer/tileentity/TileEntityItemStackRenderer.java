...
public class TileEntityItemStackRenderer
{
    ...
    public void renderByItem(final ItemStack p_192838_1_, final float p_192838_2_) {
        final Item item = p_192838_1_.getItem();
        if (item == Items.BANNER) {
            this.banner.setItemValues(p_192838_1_, false);
            TileEntityRendererDispatcher.instance.render(this.banner, 0.0, 0.0, 0.0, 0.0f, p_192838_2_);
        }
            ...
            TileEntityRendererDispatcher.instance.render(this.enderChest, 0.0, 0.0, 0.0, 0.0f, p_192838_2_);
        }
        else if (item == Item.getItemFromBlock(Blocks.TRAPPED_CHEST)) {
            TileEntityRendererDispatcher.instance.render(this.chestTrap, 0.0, 0.0, 0.0, 0.0f, p_192838_2_);
        }
        else if (Block.getBlockFromItem(item) instanceof BlockShulkerBox) {
            TileEntityRendererDispatcher.instance.render(TileEntityItemStackRenderer.SHULKER_BOXES[BlockShulkerBox.getColorFromItem(item).getMetadata()], 0.0, 0.0, 0.0, 0.0f, p_192838_2_);
        }
        else {
            TileEntityRendererDispatcher.instance.render(this.chestBasic, 0.0, 0.0, 0.0, 0.0f, p_192838_2_);
        }
    }
