...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void renderQuad(final BufferBuilder renderer, final BakedQuad quad, final int color) {
    ...
    protected void renderItemModelIntoGUI(final ItemStack stack, final int x, final int y, IBakedModel bakedmodel) {
