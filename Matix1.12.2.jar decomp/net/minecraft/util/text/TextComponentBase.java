...
public abstract class TextComponentBase implements ITextComponent
{
    ...
    public Iterator<ITextComponent> iterator() {
        return Iterators.concat((Iterator)Iterators.forArray((Object[])new TextComponentBase[] { this }), (Iterator)createDeepCopyIterator(this.siblings));
    }
    ...
    public static Iterator<ITextComponent> createDeepCopyIterator(final Iterable<ITextComponent> components) {
        Iterator<ITextComponent> iterator = Iterators.concat(Iterators.transform((Iterator)components.iterator(), (Function)new Function<ITextComponent, Iterator<ITextComponent>>() {
