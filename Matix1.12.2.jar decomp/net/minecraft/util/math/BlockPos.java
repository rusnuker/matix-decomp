...
public class BlockPos extends Vec3i
{
            ...
            public Iterator<BlockPos> iterator() {
                return (Iterator<BlockPos>)new AbstractIterator<BlockPos>() {
                    ...
                    protected BlockPos computeNext() {
                        ...
                        if (this.lastPosX == p_191532_3_ && this.lastPosY == p_191532_4_ && this.lastPosZ == p_191532_5_) {
    ...
    public static Iterable<MutableBlockPos> mutablesBetween(final int p_191531_0_, final int p_191531_1_, final int p_191531_2_, final int p_191531_3_, final int p_191531_4_, final int p_191531_5_) {
            ...
            public Iterator<MutableBlockPos> iterator() {
                return (Iterator<MutableBlockPos>)new AbstractIterator<MutableBlockPos>() {
                    ...
                    protected MutableBlockPos computeNext() {
                        if (this.pos == null) {
                            return this.pos = new MutableBlockPos(p_191531_0_, p_191531_1_, p_191531_2_);
                        }
                        if (this.pos.x == p_191531_3_ && this.pos.y == p_191531_4_ && this.pos.z == p_191531_5_) {
