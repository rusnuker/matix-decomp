...
public class TileEntityShulkerBox extends TileEntityLockableLoot implements ITickable, ISidedInventory
{
    ...
    public AxisAlignedBB getBoundingBox(final EnumFacing p_190587_1_) {
        return Block.FULL_BLOCK_AABB.expand(0.5f * this.getProgress(1.0f) * p_190587_1_.getFrontOffsetX(), 0.5f * this.getProgress(1.0f) * p_190587_1_.getFrontOffsetY(), 0.5f * this.getProgress(1.0f) * p_190587_1_.getFrontOffsetZ());
    }
            ...
            if (!list.isEmpty()) {
                for (int i = 0; i < list.size(); ++i) {
                    ...
                    if (entity.getPushReaction() != EnumPushReaction.IGNORE) {
                        ...
                        entity.move(MoverType.SHULKER_BOX, d0 * enumfacing.getFrontOffsetX(), d2 * enumfacing.getFrontOffsetY(), d3 * enumfacing.getFrontOffsetZ());
                    }
                }
            }
        }
