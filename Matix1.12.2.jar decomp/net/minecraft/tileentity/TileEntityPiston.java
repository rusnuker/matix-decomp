                ...
                for (int i = 0; i < list2.size(); ++i) {
                    ...
                    if (entity.getPushReaction() != EnumPushReaction.IGNORE) {
                        ...
                        if (d2 > 0.0) {
                            ...
                            entity.move(MoverType.PISTON, d2 * enumfacing.getFrontOffsetX(), d2 * enumfacing.getFrontOffsetY(), d2 * enumfacing.getFrontOffsetZ());
    ...
    private void fixEntityWithinPistonBase(final Entity p_190605_1_, final EnumFacing p_190605_2_, final double p_190605_3_) {
        ...
        if (axisalignedbb.intersects(axisalignedbb2)) {
            ...
            if (Math.abs(d0 - d2) < 0.01) {
                ...
                p_190605_1_.move(MoverType.PISTON, d0 * enumfacing.getFrontOffsetX(), d0 * enumfacing.getFrontOffsetY(), d0 * enumfacing.getFrontOffsetZ());
                TileEntityPiston.MOVING_ENTITY.set(null);
            }
        }
    }
