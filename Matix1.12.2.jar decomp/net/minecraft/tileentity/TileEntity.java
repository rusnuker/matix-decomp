...
public abstract class TileEntity
{
    ...
    private static void register(final String p_190560_0_, final Class<? extends TileEntity> p_190560_1_) {
        TileEntity.REGISTRY.putObject(new ResourceLocation(p_190560_0_), p_190560_1_);
    }
    
    @Nullable
    public static ResourceLocation getKey(final Class<? extends TileEntity> p_190559_0_) {
        return TileEntity.REGISTRY.getNameForObject(p_190559_0_);
    }
