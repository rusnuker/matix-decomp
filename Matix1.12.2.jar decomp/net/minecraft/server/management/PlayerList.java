...
public abstract class PlayerList
{
    ...
    public void initializeConnectionToPlayer(final NetworkManager netManager, final EntityPlayerMP playerIn) {
        ...
        final WorldServer worldserver = this.mcServer.getWorld(playerIn.dimension);
    ...
    public NBTTagCompound readPlayerDataFromFile(final EntityPlayerMP playerIn) {
        final NBTTagCompound nbttagcompound = this.mcServer.worlds[0].getWorldInfo().getPlayerNBTTagCompound();
    ...
    public EntityPlayerMP recreatePlayerEntity(final EntityPlayerMP playerIn, final int dimension, final boolean conqueredEnd) {
        ...
        final EntityPlayerMP entityplayermp = new EntityPlayerMP(this.mcServer, this.mcServer.getWorld(playerIn.dimension), playerIn.getGameProfile(), playerinteractionmanager);
        ...
        if (blockpos != null) {
            final BlockPos blockpos2 = EntityPlayer.getBedSpawnLocation(this.mcServer.getWorld(playerIn.dimension), blockpos, flag);
            if (blockpos2 != null) {
    ...
    public void changePlayerDimension(final EntityPlayerMP player, final int dimensionIn) {
        ...
        final WorldServer worldserver = this.mcServer.getWorld(player.dimension);
        player.dimension = dimensionIn;
        final WorldServer worldserver2 = this.mcServer.getWorld(player.dimension);
    ...
    public boolean canSendCommands(final GameProfile profile) {
        return ((UserList<GameProfile, V>)this.ops).hasEntry(profile) || (this.mcServer.isSinglePlayer() && this.mcServer.worlds[0].getWorldInfo().areCommandsAllowed() && this.mcServer.getServerOwner().equalsIgnoreCase(profile.getName())) || this.commandsAllowedForAll;
    }
    ...
    public void updateTimeAndWeatherForPlayer(final EntityPlayerMP playerIn, final WorldServer worldIn) {
        final WorldBorder worldborder = this.mcServer.worlds[0].getWorldBorder();
    ...
    public StatisticsManagerServer getPlayerStatsFile(final EntityPlayer playerIn) {
        ...
        if (statisticsmanagerserver == null) {
            final File file1 = new File(this.mcServer.getWorld(0).getSaveHandler().getWorldDirectory(), "stats");
    ...
    public PlayerAdvancements getPlayerAdvancements(final EntityPlayerMP p_192054_1_) {
        ...
        if (playeradvancements == null) {
            final File file1 = new File(this.mcServer.getWorld(0).getSaveHandler().getWorldDirectory(), "advancements");
            final File file2 = new File(file1, uuid + ".json");
    ...
    public void setViewDistance(final int distance) {
        ...
        if (this.mcServer.worlds != null) {
            for (final WorldServer worldserver : this.mcServer.worlds) {
                if (worldserver != null) {
