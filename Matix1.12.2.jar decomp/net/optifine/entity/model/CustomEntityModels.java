...
public class CustomEntityModels
{
    ...
    private static Map<Class<? extends Entity>, Render<? extends Entity>> originalEntityRenderMap;
    private static Map<Class<? extends TileEntity>, TileEntitySpecialRenderer<? extends TileEntity>> originalTileEntityRenderMap;
    
    public static void update() {
        final Map<Class<? extends Entity>, Render<? extends Entity>> map = getEntityRenderMap();
        final Map<Class<? extends TileEntity>, TileEntitySpecialRenderer<? extends TileEntity>> map2 = getTileEntityRenderMap();
        if (map == null) {
    ...
    private static Map<Class<? extends Entity>, Render<? extends Entity>> getEntityRenderMap() {
        ...
        final Map<Class<? extends Entity>, Render<? extends Entity>> map = rendermanager.getEntityRenderMap();
        if (map == null) {
            return null;
        }
        if (CustomEntityModels.originalEntityRenderMap == null) {
            CustomEntityModels.originalEntityRenderMap = new HashMap<Class<? extends Entity>, Render<? extends Entity>>(map);
        }
        return map;
    }
    
    private static Map<Class<? extends TileEntity>, TileEntitySpecialRenderer<? extends TileEntity>> getTileEntityRenderMap() {
        final Map<Class<? extends TileEntity>, TileEntitySpecialRenderer<? extends TileEntity>> map = TileEntityRendererDispatcher.instance.renderers;
        if (CustomEntityModels.originalTileEntityRenderMap == null) {
            CustomEntityModels.originalTileEntityRenderMap = new HashMap<Class<? extends TileEntity>, TileEntitySpecialRenderer<? extends TileEntity>>(map);
        }
        return map;
    }
